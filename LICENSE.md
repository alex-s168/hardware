...
as well as all lines in the source code containing `Copyright (C)`, for example:
...
a permitted purpose if your company has fewer than 50 total
individuals working as employees and independent contractors,
and less than 500,000 USD (2019) total revenue in the prior
...
Use by any educational institution is use for a permitted purpose
